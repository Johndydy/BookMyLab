...
<div class="mb-4">
    ...
    <h2><i class="bi bi-shield-check"></i> Edit Role: {{ $role->name }}</h2>
</div>
                ...
                <form action="{{ route('admin.roles.update', $role) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror"
                                  ...
                                  placeholder="Role description and responsibilities">{{ old('description', $role->description) }}</textarea>
                                ...
                                @forelse($permissions as $permission)
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" 
                                               ...
                                               {{ $role->permissions->contains('permission_id', $permission->permission_id) ? 'checked' : '' }}>
