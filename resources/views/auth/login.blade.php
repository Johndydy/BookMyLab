...
<body>
    <div class="login-box">
        <div class="text-center mb-4">
            <h1>BookMyLab</h1>
            <p class="text-muted">Laboratory Booking Portal</p>
        </div>
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('login') is-invalid @enderror" id="login" name="login"
                    value="{{ old('login') }}" placeholder="Enter your login identifier" required autofocus>
                @error('login')
        ...
        <div class="position-relative my-4">
            ...
            <span class="position-absolute top-50 start-50 translate-middle bg-white px-3 text-muted"
                style="font-size: 0.8rem;">OR</span>
        </div>
        ...
        <div class="text-center mt-4">
            <p class="text-muted mb-0">Don't have an account? <a href="{{ route('register') }}"
                    style="color: #1a2e4a; font-weight: 500;">Register here</a></p>
        </div>
    </div>
